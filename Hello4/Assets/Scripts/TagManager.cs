...
public class AnimationTags {
    ...
    public const string LIGHTTTACK_1_TRIGGER = "LightAttack1";
    public const string LIGHTTTACK_2_TRIGGER = "LightAttack2";
    public const string LIGHTTTACK_3_TRIGGER = "LightAttack3";
